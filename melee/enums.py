...
class ProjectileSubtype(Enum):
    ...
    DOC_CAPSULE = 0x31 # Dr.Mario's Capsule
    ...
    NESS_FIRE = 0x42 # NESS Fire
    NESS_FLASH_1 = 0x43 # NESS Flash
    NESS_FLASH_2 = 0x44 # NESS Flash
    NESS_THUNDER_HEAD = 0x45 # NESS Thunder (Primary)
    NESS_THUNDER_TAIL_1 = 0x46 # NESS Thunder
    NESS_THUNDER_TAIL_2 = 0x47 # NESS Thunder
    NESS_THUNDER_TAIL_3 = 0x48 # NESS Thunder
    NESS_THUNDER_TAIL_4 = 0x49 # NESS Thunder
    LINK_ARROW = 0x4C # Link's Arrow
    YLINK_ARROW = 0x4D # Young Link's arrow
    NESS_FLASH_EXPLOSION = 0x4E # NESS Flash (explosion)
    SHEIK_NEEDLE_THROWN = 0x4F # Needle(thrown)
    PIKACHU_THUNDER = 0x51 # Pikachu's Thunder
    PICHU_THUNDER = 0x52 # Pichu's Thunder
    MARIO_CAPE = 0x53 # Mario's cape
    DOC_CAPE = 0x54 # Dr.Mario's cape
    ...
    PEACH_TURNIP = 0x63 # Turnip
    BOWSER_FLAME = 0x64 # Bowser's flame
    NESS_BATT = 0x65 # Ness's bat
    NESS_YOYO = 0x66 # Yoyo
    PEACH_PARASOL = 0x67 # Peach's parasol
    LUIGI_FIRE = 0x69 # Luigi's fire
    ICECLIMBERS_BLOCK = 0x6A # Ice(Iceclimbers)
    ICECLIMBERS_BLIZZARD = 0x6B # Blizzard
    ZELDA_FIRE = 0x6C # Zelda's fire
    ZELDA_FIRE_EXPLOSION = 0x6D # Zelda's fire (explosion)
    PEACH_TOAD_SPORE = 0x6F # Toad's spore
    MEWTWO_SHADOWBALL = 0x70 # Mewtwo's Shadowball
    ICECLIMBERS_UP_B = 0x71 # Iceclimbers' Up  #B
    GAMEANDWATCH_PESTICIDE = 0x72 # Pesticide
    GAMEANDWATCH_MANHOLE = 0x73 # Manhole
    GAMEANDWATCH_GW_FIRE = 0x74 # Fire(G&W)
    GAMEANDWATCH_PARACHUTE = 0x75 # Parachute
    GAMEANDWATCH_TURTLE = 0x76 # Turtle
    GAMEANDWATCH_SPERKY = 0x77 # Sperky
    GAMEANDWATCH_JUDGE = 0x78 # Judge
    GAMEANDWATCH_SAUSAGE = 0x7A # Sausage
    YLINK_MILK = 0x7B # Milk (Young Link)
    GAMEANDWATCH_FIREFIGHTER = 0x7C # Firefighter(G&W)
    KIRBY_MARIO_FIRE = 0x82 # Kirby copy Mario's Fire (B)
    KIRBY_DOC_FIRE = 0x83 # Kirby copy Dr. Mario's Capsule (B)
    KIRBY_LUIGI_FIRE = 0x84 # Kirby copy Luigi's Fire (B)
    KIRBY_ICECLIMBERS_BLOCK = 0x85 # Kirby copy IceClimber's IceCube (B)
    KIRBY_PEACH_TOAD_SPORE = 0x87 # Kirby copy Toad's Spore (B)
    ...
    KIRBY_MEWTWO_SHADOWBALL = 0x90 # Kirby copy Mewtwo's Shadowball (B)
    KIRBY_NESS_FLASH = 0x91 # Kirby copy NESS Flash (B)
    KIRBY_NESS_FLASH_EXPLOSION = 0x92 # Kirby copy NESS Flash Explosion (B)
    ...
    KIRBY_GAMEANDWATCH_SAUSAGE = 0x9B # Kirby copy Mr. Game & Watch's Sausage (B)
